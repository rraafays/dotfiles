...
complete -c rebuild -f -a timers -d "Show nixos-upgrade, nix-optimise, nix-gc service timers"
complete -c rebuild -f -a logs -d "Show nixos-upgrade, nix-optimise, nix-gc service logs"
