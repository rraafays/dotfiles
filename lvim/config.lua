...
lvim.keys.insert_mode["<Down><Down>"] = "⇓"
lvim.keys.insert_mode["<Left><Left>"] = "<="
lvim.keys.insert_mode["<Up><Up><Up>"] = "↑"
lvim.keys.insert_mode["<Right><Right><Right>"] = "->"
lvim.keys.insert_mode["<Down><Down><Down>"] = "↓"
lvim.keys.insert_mode["<Left><Left><Left>"] = "<-"
...
lvim.keys.insert_mode["<A-Tab>"] = "ctrl"
lvim.keys.insert_mode["<A-Tab><A-Tab>"] = "shift"
lvim.keys.insert_mode["<A-Tab><A-Tab><A-Tab>"] = "opt"
lvim.keys.insert_mode["<A-Tab><A-Tab><A-Tab><A-Tab>"] = "cmd"
